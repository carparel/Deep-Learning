...
model = Sequential(Linear(2,25), ReLU(), Dropout(0.5), Linear(25,25), Tanh(), Linear(25,25), ReLU(), Linear(25,2), Sigmoid())
print('Model: Linear(2,25), ReLU(), Linear(25,25), Tanh(), Linear(25,25), ReLU(), Linear(25,2), Sigmoid()')
